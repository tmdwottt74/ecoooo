...
async def chatbot_endpoint(request: ChatRequest):
    ...
    You must choose one of the following three actions and respond only in JSON format. Do not add any other explanations.
    ...
    3. "direct_answer": Choose this for simple greetings or small talk, like "Hello", "Thank you", or "Who are you?".

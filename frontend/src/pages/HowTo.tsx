...
const HowTo: React.FC = () => {
  ...
  const steps: HowToStep[] = [
    ...
    },
    {
      ...
      icon: "🤖",
      details: [
        "AI 챗봇에게 오늘의 친환경 활동을 알려주세요. (예: '오늘 자전거로 출근했어')",
        "챗봇이 활동 기록을 확인하고 사실일 경우 추가 보너스 크레딧을 지급합니다.",
        "활동에 대한 보너스 크레딧은 하루에 한 번만 지급됩니다.",
        "환경 관련 정보나 나의 활동 요약(탄소 절감량, 포인트 등)도 질문할 수 있습니다."
      ]
    },
    {
      id: 3,
